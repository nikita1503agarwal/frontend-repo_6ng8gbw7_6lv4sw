        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-violet-600/30 via-fuchsia-500/20 to-amber-400/20 p-8 md:p-12">
          <div className="grid items-center gap-8 md:grid-cols-2">
            ...
            <form className="grid gap-3 md:grid-cols-3">
              ...
              <button type="submit" className="rounded-xl bg-gradient-to-r from-violet-600 via-fuchsia-500 to-amber-400 px-5 py-3 font-semibold text-white shadow-[0_12px_30px_-10px_rgba(139,92,246,0.7)] hover:brightness-110 transition">Book a demo</button>
            </form>
          </div>
        </div>
      </div>
